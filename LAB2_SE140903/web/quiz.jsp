<%-- 
    Document   : quiz
    Created on : Feb 7, 2021, 11:54:31 AM
    Author     : truon
--%>
        ...
        <header class="header-area overlay">
                ...
                <div class="container">
                    ...
                    <div id="main-nav" class="collapse navbar-collapse">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li><a href="ShowHistory?txtEmailSearch=${sessionScope.LOGIN_USER.email}" class="nav-item nav-link">History</a></li>
            ...
            <div class="banner">
                <div class="container">
                    ...
                    <p>Please select the subject you want to do</p>
                    ...
                    <c:if test="${not empty requestScope.ERROR_SHOW_QUESTION}">
                        <div class="alert alert-danger">
                            <strong>Warning!</strong> ${requestScope.ERROR_SHOW_QUESTION}.
                        </div>
                    </c:if>
                </div>
            </div>
