<%-- 
    Document   : result
    Created on : Feb 13, 2021, 12:37:46 AM
    Author     : truon
--%>
    ...
    <body>
        ...
        <header class="header-area overlay">
            ...
            <div class="banner">
                <div class="container">
                    <h1 >Result</h1>
                    <p>Number of correct answer: ${requestScope.numberCorrect}/${requestScope.numberQuizExam}</p>
                    <p>Point: ${requestScope.point}</p>  
                    <a href="quiz" class="button button-primary">Back to home</a>
                </div>
