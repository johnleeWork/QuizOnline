<%-- 
    Document   : login
    Created on : Jan 31, 2021, 12:33:17 AM
    Author     : truon
--%>
                                ...
                                <div class="form-wrap bg-white">
                                    ...
                                    <form class="form" method="post" action="Login">
                                        <div class="row">
                                            ...
                                            <c:set var="error" value="${requestScope.ERROR_LOGIN}"></c:set>
                            ...
                            <div class="col-md-6">
                                <div class="content text-center">
                                    <div class="border-bottom pb-5 mb-5">
                                        ...
                                        <a href="register" class="btn btn-custom" style="color: blue">Register</a>
                                    </div>
                                </div>
                            </div>
                        </div>
