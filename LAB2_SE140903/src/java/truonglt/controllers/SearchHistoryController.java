...
public class SearchHistoryController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = SUCCESS;
        try {
            String email = request.getParameter("txtEmailSearch");
            ...
            int noOfPages = (int) Math.ceil(exam.getNumberExam(subjectID, email) * 1.0 / pageSize);
            session.setAttribute("HISTORY_EXAM", exam.searchExamHistory(subjectID, email, pageSize, pageNum));          
