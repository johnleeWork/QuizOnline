...
public class AuthenticateFilter implements Filter {
    ...
    public AuthenticateFilter() {
        ...
        USER.add("ShowHistory");
        USER.add("ShowHistoryDetail");
        USER.add("ShowQuestion");
        USER.add("ShowResultTimeOut");        
        USER.add("history");
        USER.add("historyDetail");
        USER.add("quiz");
        USER.add("quizTest");
        USER.add("result");
        ...
        ADMIN.add("DeleteQuestion");
        ADMIN.add("SearchAD");
        ADMIN.add("ShowEdit");
        ADMIN.add("UpdateQuestion");
        ADMIN.add("add");
        ADMIN.add("edit");
        ADMIN.add("quizManager");
